...
void main() {
  ...
  group('TopicDiscoveryService', () {
    ...
    test('discoverSuggestedTopics returns empty list when AI model is missing', () async {
    ...
    test('getNoteIdsForTopic returns empty list when AI model is missing', () async {
      final ids = await TopicDiscoveryService.getNoteIdsForTopic('Software & Programming');
      expect(ids, isEmpty);
    });
  });
}
