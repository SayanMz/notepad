    ...
    return [
      ...
      NotesSection(
        ...
        content:
            ...
            'perform stretch-and-folds every 30 minutes, and bake in a preheated Dutch oven at 230°C.',
        cardColorValue: 0xFFF59E0B, // Amber
      ),

      // --- NOTE 6: SOFTWARE & PROGRAMMING ---
      NotesSection(
        title: 'App Performance Optimization',
        content:
            'Engineering Roadmap:\n'
            '- Isolate database queries off the main thread to prevent frame drops.\n'
            ...
            '- Implement LRU caching for high-frequency model inference outputs.',
