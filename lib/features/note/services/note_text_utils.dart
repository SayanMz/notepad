...
/// Normalizes note text into short preview lines for cards and search results.
...
List<String> extractSearchSnippets(String content, String query, {int maxLines = 2}) {
...
/// Removes the leading list marker so search previews read more naturally.
